...
import EditCampaignPage from './view';

/**
 * Campaign detail, addressed as `/campaigns/view?id=…` rather than as a
 * dynamic `[id]` segment.
 *
 ...
 * the ids generateStaticParams returned, which means every real campaign
