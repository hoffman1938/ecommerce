...
import AdminOrderDetailPage from './view';

/**
 * Order detail, addressed as `/orders/view?id=…` rather than as a
 * dynamic `[id]` segment.
 *
 ...
 * the ids generateStaticParams returned, which means every real order
