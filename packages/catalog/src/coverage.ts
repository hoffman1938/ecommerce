 ...
 */
const MODELS = [
  'Alder', 'Harbour', 'Meridian', 'Compass', 'Orchard', 'Kestrel', 'Marlow',
  'Sable', 'Juniper', 'Bramble', 'Aurora', 'Cavendish', 'Ellery', 'Fenwick',
  'Granby', 'Halcyon', 'Ivorine', 'Jetty', 'Kinross', 'Lachlan', 'Mabry',
  'Norwood', 'Ondine', 'Pallas', 'Quill', 'Ramsay', 'Selby', 'Tamsin',
  'Ulverton', 'Vesper', 'Wexford', 'Yarrow', 'Zephyr', 'Ashcombe', 'Bellamy',
  'Corvine', 'Dunmore', 'Everly', 'Fairlie', 'Gresham',
];

/** Brand slugs, mirroring BRANDS in ./spec. Kept as slugs — ProductSpec takes a slug. */
const BRAND_SLUGS = [
  'aster', 'northline', 'velora', 'maison-rue', 'urban-theory',
  'lunaro', 'everline', 'monarch', 'atelier-nine', 'forma',
];
