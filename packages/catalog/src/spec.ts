...
export const CATEGORIES: CategorySpec[] = [
  ...
  { name: 'Bags', slug: 'bags', position: 6, parentSlug: null },
  { name: 'Accessories', slug: 'accessories', position: 7, parentSlug: null },
  { name: 'Running Shoes', slug: 'running-shoes', position: 1, parentSlug: 'shoes' },
  { name: 'Sneakers', slug: 'sneakers', position: 2, parentSlug: 'shoes' },
  { name: 'Boots', slug: 'boots', position: 3, parentSlug: 'shoes' },
  { name: 'Backpacks', slug: 'backpacks', position: 1, parentSlug: 'bags' },
  { name: 'Shoulder Bags', slug: 'shoulder-bags', position: 2, parentSlug: 'bags' },
];
