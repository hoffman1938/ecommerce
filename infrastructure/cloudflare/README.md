...
- `admin-demo-deploy.md` — **working** Pages configuration for the static admin panel
  demo (no backend required); a separate Pages project from the storefront
...
- `r2-migration.md` — moving object storage from MinIO to R2
- `turnstile.md` — enabling bot protection through the captcha interface
- `api-cors-and-domains.md` — cross-domain cookies, CORS, custom domains, cache policy
